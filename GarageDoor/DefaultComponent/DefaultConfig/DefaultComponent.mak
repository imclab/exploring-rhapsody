...
FLAGSFILE=
RULESFILE=
OMROOT="C:\Program Files (x86)\IBM\Rational\Rhapsody\8.0\Share"
...
GarageDoor.obj : GarageDoor.cpp GarageDoor.h    Default.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"GarageDoor.obj" "GarageDoor.cpp" 



Default.obj : Default.cpp Default.h    GarageDoor.h 
	$(CREATE_OBJ_DIR)
